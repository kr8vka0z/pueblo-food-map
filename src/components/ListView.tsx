...
export default function ListView({
  ...
  return (
    <div className="absolute inset-0 z-[700] flex flex-col bg-[var(--color-bone-50)] overflow-hidden">
      ...
      {/* Below xl the bottom nav bar sits over the list's last row; the extra
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain pb-[calc(78px+env(safe-area-inset-bottom)+24px)] xl:pb-6">
        {venues.length === 0 ? (
