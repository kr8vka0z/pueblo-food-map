 ...
 *
 * The scheduled()-handler wiring (the ping + this cleanup + the sibling
 * refresh-pipeline alerts, #238/#234) lives in `src/lib/scheduledTasks.ts`,
 * not here — this file owns only the retention SQL/gate; see that file's
 * header for why the orchestration itself is a separate module.
 *
