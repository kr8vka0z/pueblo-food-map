...
const en: Record<string, string> = {
  ...
  "feedback.email.hint": "Only used if we want to follow up with you.",
...
const es: Record<string, string> = {
  ...
  "feedback.email.label": "Tu correo electrónico (opcional)",
  "feedback.email.placeholder": "correo@ejemplo.com",
  "feedback.email.hint": "Solo se usa si queremos hacerte un seguimiento.",
